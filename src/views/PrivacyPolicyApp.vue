    ...
    <div class="h-auto justify-center flex bg-[#F5F5F5] mt-16">
        <div class="py-32 sm:py-32 max-w-6xl mx-2 sm:mx-10 my-auto w-full flex flex-col sm:flex-row justify-left">
            <div class="px-2 h-auto w-full  font-[SourceSansPro] sm:mr-6 text-left sm:text-left">
                ...
                <p>This privacy policy applies to the Distance Reacher app (hereby referred to as "Application") for
                    mobile devices that was created by Marco Huber (hereby referred to as "Service Provider") as a Free
                ...
                <p></p><br>
                <p style="display: none;">The Application does not gather precise information about the location of your
                    mobile device.</p>
                <div style="">
                    ...
                    <ul>
                        <li>Geolocation Services: The Service Provider utilizes location data to provide features such
                            as personalized content, relevant recommendations, and location-based services.</li>
                ...
                <p>The Service Provider will retain User Provided data for as long as you use the Application and for a
                    ...
                    via the Application, please contact them at impactfulvoyage@gmail.com and they will respond in a
                    reasonable time.</p><br><strong>Children</strong>
                ...
                <div><br>
                    <p>The Application does not address anyone under the age of 13. The Service Provider does not
                        ...
                        contact the Service Provider (impactfulvoyage@gmail.com) so that they will be able to take the
                        necessary actions.</p>
                ...
                <p>This privacy policy is effective as of 2024-06-07</p><br><strong>Your Consent</strong>
                ...
                <p>If you have any questions regarding privacy while using the Application, or have questions about the
                    practices, please contact the Service Provider via email at impactfulvoyage@gmail.com.</p>
                <hr>
