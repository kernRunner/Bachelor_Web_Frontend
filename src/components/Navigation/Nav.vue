<template>
    <Disclosure as="nav" ref="navBar" id="navBar" class=" fixed z-50 left-0 right-0 top-0 ease-in-out duration-100 "
        :class="[navbarScrolled ? 'bg-white border-b border-lightgray ' : '']" v-slot="{ open }">
                ...
                <div class="flex items-center justify-center sm:items-stretch sm:justify-end">
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <div class="relative inline-block text-left" @mouseover="openDropmenu()" @mouseleave="openDropdown = false">
                                <div>
                                    <button 
                                ...
                                <div v-if="openDropdown"
                                    class="absolute left-0 w-48 mt-[0px] ml-[-6px] origin-top-left bg-white divide-y divide-gray-100 rounded-md shadow-lg"
        ...
        <DisclosurePanel class="sm:hidden ">
            <div class="px-2 pb-3 pt-2 relative inline-block pr-12 rounded-lg"
                ...
                <RouterLink :to="{ name: 'favorite' }"
                    class="block rounded-md px-3 py-2 text-base font-medium text-black">
                    Favorite
                </RouterLink>
            </div>
        </DisclosurePanel>
